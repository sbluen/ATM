...
CREATE TABLE `transactions` (
  ...
  CONSTRAINT `transactions_references_accounts` FOREIGN KEY (`accno`) REFERENCES `accounts` (`accno`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2015-01-20 13:43:28
